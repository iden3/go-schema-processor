...
func TestMerklizer_ArrayList(t *testing.T) {
	// @list
	var cred = `{"id":"urn:uuid:97fbd3d0-8eb7-11ee-8085-a27b3ddbdc29","@context":["https://www.w3.org/2018/credentials/v1","https://schema.iden3.io/core/jsonld/iden3proofs.jsonld","https://raw.githubusercontent.com/iden3/claim-schema-vocab/test/cred-array/schemas/json-ld/kyc-v4-arr-list.jsonld"],"type":["VerifiableCredential","KYCAgeCredential"],"expirationDate":"2361-03-21T21:14:48+02:00","issuanceDate":"2023-11-29T15:02:47.508637+02:00","credentialSubject":{"birthday":19960424,"documentType":2,"id":"did:polygonid:polygon:mumbai:2qDAxLyxvGaGqBLmoDHwohHjtevVdYvpnWcYiK6AcK","items":["1","2","3"],"type":"KYCAgeCredential"},"credentialStatus":{"id":"http://localhost:8001/api/v1/identities/did%3Apolygonid%3Apolygon%3Amumbai%3A2qGF2TDJZLxzNU1mP3x5PwcUF43vMgdrhRQhaM2HnG/claims/revocation/status/239691578","revocationNonce":239691578,"type":"SparseMerkleTreeProof"},"issuer":"did:polygonid:polygon:mumbai:2qGF2TDJZLxzNU1mP3x5PwcUF43vMgdrhRQhaM2HnG","credentialSchema":{"id":"https://raw.githubusercontent.com/iden3/claim-schema-vocab/test/cred-array/schemas/json/KYCAgeCredential-v4-arr-list.json","type":"JsonSchema2023"},"proof":[{"type":"BJJSignature2021","issuerData":{"id":"did:polygonid:polygon:mumbai:2qGF2TDJZLxzNU1mP3x5PwcUF43vMgdrhRQhaM2HnG","state":{"claimsTreeRoot":"c1c8e90aa0490dda3603ac724dc50c89f0605ec5bfde20d89f260cf6e9f57b23","value":"8f0d09204a53282008eb60224f7705304608a1879195fd68255e964e7b56781d"},"authCoreClaim":"","mtp":{"existence":true,"siblings":[]},"credentialStatus":{"id":"http://localhost:8001/api/v1/identities/did%3Apolygonid%3Apolygon%3Amumbai%3A2qGF2TDJZLxzNU1mP3x5PwcUF43vMgdrhRQhaM2HnG/claims/revocation/status/0","revocationNonce":0,"type":"SparseMerkleTreeProof"}},"coreClaim":"","signature":"894bcdadc3bcd3c5859d7a46ba252abc5ee061ecbcc43eb7c6f9dd8e02bbc081b0d1f7068a83a71f2f5b1eeb82fea4789c551e4a6aa59347ee1a3464a355a604"}]}`
	_, err := MerklizeJSONLD(context.Background(), strings.NewReader(cred))
	require.NoError(t, err)

}
func TestMerklizer_ArrayPrimitive(t *testing.T) {
	// array of primitive
	var cred = `{"id":"urn:uuid:279c93ac-8ea0-11ee-a8a5-a27b3ddbdc29","@context":["https://www.w3.org/2018/credentials/v1","https://schema.iden3.io/core/jsonld/iden3proofs.jsonld","https://raw.githubusercontent.com/iden3/claim-schema-vocab/test/cred-array/schemas/json-ld/kyc-v4-arr.jsonld"],"type":["VerifiableCredential","KYCAgeCredential"],"expirationDate":"2361-03-21T21:14:48+02:00","issuanceDate":"2023-11-29T12:15:00.554729+02:00","credentialSubject":{"birthday":19960424,"documentType":2,"id":"did:polygonid:polygon:mumbai:2qHnd9cTCDQLA55Ssr11dCLNSgFhwCT3sypsWvgBr2","items":["1","2","3"],"type":"KYCAgeCredential"},"credentialStatus":{"id":"http://localhost:8001/api/v1/identities/did%3Apolygonid%3Apolygon%3Amumbai%3A2qCxZzSQgMK5jGYhGt3GEez8hkEs7X62YQMPjZvbhm/claims/revocation/status/3558041768","revocationNonce":3558041768,"type":"SparseMerkleTreeProof"},"issuer":"did:polygonid:polygon:mumbai:2qCxZzSQgMK5jGYhGt3GEez8hkEs7X62YQMPjZvbhm","credentialSchema":{"id":"https://raw.githubusercontent.com/iden3/claim-schema-vocab/test/cred-array/schemas/json/KYCAgeCredential-v4-arr.json","type":"JsonSchema2023"},"proof":[{"type":"BJJSignature2021","issuerData":{"id":"did:polygonid:polygon:mumbai:2qCxZzSQgMK5jGYhGt3GEez8hkEs7X62YQMPjZvbhm","state":{"claimsTreeRoot":"89c0f06ad1ee611802832ee34a81af14a2eb6d25105fbec977cbf8a369abb91d","value":"c8588e69cc0ad2baf63072fb573ace89a23236b5e1e074000b1f773be9ea1508"},"authCoreClaim":"","mtp":{"existence":true,"siblings":[]},"credentialStatus":{"id":"http://localhost:8001/api/v1/identities/did%3Apolygonid%3Apolygon%3Amumbai%3A2qCxZzSQgMK5jGYhGt3GEez8hkEs7X62YQMPjZvbhm/claims/revocation/status/0","revocationNonce":0,"type":"SparseMerkleTreeProof"}},"coreClaim":"","signature":"bdc897145939474b0ece703d328e0e178dab3eab03d5d257f96ec3e7e305bc21fd44667bd1d74f5ef7963e04027d8d9b74750db6178826a8138685aaa80aea02"}]}`
	_, err := MerklizeJSONLD(context.Background(), strings.NewReader(cred))
	require.NoError(t, err)
